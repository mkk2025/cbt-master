...
* Before you put time into a non-trivial patch, it is worth discussing it privately by [email](mailto:contact@corebrimtech.com).
* Do not change style on numerous files in one single pull request, we can [discuss](mailto:contact@corebrimtech.com) about those before doing any major restyling, but be sure that personal preferences not having a strong support in [PEP 8](http://www.python.org/dev/peps/pep-0008/) will likely to be rejected.
