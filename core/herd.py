...
class Herd(object):
    ...
    def format(self, out):
        ...
        print("MEMCACHEDs: " + str(self.ufonet.total_memcached) + " | Attacks: " + str(self.ufonet.total_memcached))
        print("SSDPs: " + str(self.ufonet.total_ssdp) + " | Attacks: " + str(self.ufonet.total_ssdp))
        print("CHARGENs: " + str(self.ufonet.total_chargen) + " | Attacks: " + str(self.ufonet.total_chargen))
        print("HTTP2s: " + str(self.ufonet.total_http2reset + self.ufonet.total_http2zerowin) + " | Attacks: " + str(self.ufonet.total_http2reset + self.ufonet.total_http2zerowin))
        print("RUDYs: " + str(self.ufonet.total_rudy) + " | Attacks: " + str(self.ufonet.total_rudy))
        print("COAPs: " + str(self.ufonet.total_coap) + " | Attacks: " + str(self.ufonet.total_coap))
        print("-"*21)
        print("\n") # gui related
        print('='*21)
